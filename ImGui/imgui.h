...
namespace ImGui
{
    ...
    IMGUI_API void          Spacing(int spacing = 0);                                                      // add vertical spacing.
    ...
    IMGUI_API bool          Tab(const char* label, int number, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0));
    ...
    IMGUI_API bool          ColorEdit(const char* label, Color* newcolor, ImGuiColorEditFlags flags = 0, bool scripts = false, int value = 1);
