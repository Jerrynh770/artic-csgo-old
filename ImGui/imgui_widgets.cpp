...
bool ImGui::SubTabEx(const char* label, bool* active, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    ImVec4 hover;
    if (*active)
        hover = ImColor(136, 125, 231, 255);
    else
        hover = ImColor(83, 75, 151, 0);

    GetWindowDrawList()->AddRectFilled(ImVec2(bb.Min.x, bb.Max.y - 4 * c_menu::get().dpi_scale), ImVec2(bb.Max.x, bb.Max.y), GetColorU32(hover), 25.f);
    PushFont(c_menu::get().tab);
    PushStyleColor(ImGuiCol_Text, ImVec4(1.59f, 1.59f, 1.59f, 1.f));
    RenderTextClipped(ImVec2(bb.Min.x, bb.Min.y + 3), ImVec2(bb.Max.x, bb.Max.y), label, NULL, &label_size, ImVec2(0.5f, 0.5f), &bb);;
    PopStyleColor();
    PopFont();
...
bool ImGui::TabEx(const char* label, int number, bool* active, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    // ImGui::Spacing(5);
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
    ...
    if ((flags & ImGuiButtonFlags_AlignTextBaseLine) && style.FramePadding.y < window->DC.CurrLineTextBaseOffset) // Try to vertically align buttons that are smaller/have no padding so that text baseline matches (bit hacky, since it shouldn't be a flag)
        pos.y += window->DC.CurrLineTextBaseOffset - style.FramePadding.y;
    ImVec2 size = CalcItemSize(size_arg, style.FramePadding.x * 2.0f, style.FramePadding.y * 2.0f);
    ...
    if (*active) {
        x = 0;
        hover_dis2 = ImColor(136, 125, 231, 255);
    }
    else {
        x = 0;
        hover_dis2 = ImColor(GetColorU32(ImGuiCol_TabUnfocusedActive));
    }
    GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, GetColorU32(hover_dis2), 4.f);

    if (number == 1)
        GetWindowDrawList()->AddImage(c_menu::get().icons[0], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    if (number == 2)
        GetWindowDrawList()->AddImage(c_menu::get().icons[1], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    if (number == 3)
        GetWindowDrawList()->AddImage(c_menu::get().icons[2], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    if (number == 4)
        GetWindowDrawList()->AddImage(c_menu::get().icons[3], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    if (number == 5)
        GetWindowDrawList()->AddImage(c_menu::get().icons[4], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    if (number == 6)
        GetWindowDrawList()->AddImage(c_menu::get().icons[5], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    if (number == 7)
        GetWindowDrawList()->AddImage(c_menu::get().icons[6], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    if (number == 8)
        GetWindowDrawList()->AddImage(c_menu::get().icons[7], ImVec2(bb.Min.x + 10 * c_menu::get().dpi_scale + x, bb.Min.y + 13 * c_menu::get().dpi_scale), ImVec2(bb.Min.x + 26 * c_menu::get().dpi_scale + x, bb.Min.y + 29 * c_menu::get().dpi_scale), ImVec2(0, 0), ImVec2(1, 1));
    PushFont(c_menu::get().tab);
    GetWindowDrawList()->AddText(ImVec2(bb.Min.x + 40 * c_menu::get().dpi_scale + x, bb.Min.y + 9 * c_menu::get().dpi_scale), ImColor(255, 255, 255, 255), label);
    PopFont();
    IMGUI_TEST_ENGINE_ITEM_INFO(id, label, window->DC.LastItemStatusFlags);
    return pressed;
}

bool ImGui::Tab(const char* label, int number, bool active, const ImVec2& size_arg)
{
    return TabEx(label, number, &active, size_arg, 0);
}
bool ImGui::KeybindButton(const char* label, const char* unique_id, const ImVec2& size_arg, bool clicked, ImGuiButtonFlags flags, const char* text)
{
    ImGui::Spacing(10);
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
    ...
    const ImRect frame_bb(window->DC.CursorPos + ImVec2(205 * c_menu::get().dpi_scale, 0), window->DC.CursorPos + ImVec2(308 * c_menu::get().dpi_scale, size.y));
    const ImRect total_bb(window->DC.CursorPos, frame_bb.Max);
    const ImVec2 text_bb(window->DC.CursorPos + ImVec2(20 * c_menu::get().dpi_scale, 0));
    ItemSize(size, style.FramePadding.y);
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, frame_bb.Max, GetColorU32(ImGuiCol_Active), 4.f);
    window->DrawList->AddImage(c_menu::get().icons[6], ImVec2(frame_bb.Max.x - 19 * c_menu::get().dpi_scale, frame_bb.Min.y + 5 * c_menu::get().dpi_scale), frame_bb.Max - ImVec2(5 * c_menu::get().dpi_scale, 5 * c_menu::get().dpi_scale));
    RenderText(frame_bb.Min + ImVec2(7 * c_menu::get().dpi_scale, 0), text);

    RenderText(text_bb, label);
...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    const ImRect bb(pos + ImVec2(19, 0), pos + size);
    ItemSize(size, style.FramePadding.y);
    if (!ItemAdd(bb, id))
        return false;
    ...
    // Render
    const ImU32 col = GetColorU32((held && hovered) ? ImVec4(136 / 255.f, 125 / 255.f, 231 / 255.f, 1.00f) : hovered ? ImVec4(136 / 255.f, 125 / 255.f, 231 / 255.f, 1.00f) : ImVec4(146 / 255.f, 135 / 255.f, 241 / 255.f, 1.00f));

    GetWindowDrawList()->AddRectFilled(bb.Min, bb.Max, col, 4.f);
    RenderNavHighlight(bb, id);
    RenderTextClipped(bb.Min, bb.Max, label, NULL, &label_size, ImVec2(0.5f, 0.5f), &bb);
...
bool ImGui::CustomButton(const char* label, const char* label_id, const ImVec2& size_arg, bool use_icon, ImFont* icon_font, const char* icon_label)
{
    ...
    const ImRect bb(pos + ImVec2(21, 0), pos + size);
    ItemSize(size, style.FramePadding.y);
    if (!ItemAdd(bb, id))
        return false;
...
bool ImGui::ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col)
{
    ...
    // Render
    const ImU32 col = GetColorU32(ImGuiCol_ChildBg);

    RenderNavHighlight(bb, id);
    RenderFrame(bb.Min, bb.Max, col, true, ImClamp((float)ImMin(padding.x, padding.y), 0.0f, 4.f));
    if (bg_col.w > 0.0f)
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    const ImGuiID id = window->GetID(label);
    const ImVec2 label_size = CalcTextSize(label, NULL, true);
    const ImRect text_bb(window->DC.CursorPos + ImVec2(63 * c_menu::get().dpi_scale, style.FramePadding.y - 0), window->DC.CursorPos + ImVec2(63 * c_menu::get().dpi_scale, style.FramePadding.y) + label_size);
    const ImRect check_bb(ImVec2(window->DC.CursorPos.x + 22 * c_menu::get().dpi_scale, window->DC.CursorPos.y + 5 * c_menu::get().dpi_scale), window->DC.CursorPos + ImVec2(14 * c_menu::get().dpi_scale, 0) - ImVec2(0, 3 * c_menu::get().dpi_scale) + ImVec2(label_size.y + style.FramePadding.y * 2, label_size.y + style.FramePadding.y * 2));
    ...
    if (label_size.x > 0)
    {
        ...
        total_bb = ImRect(ImMin(check_bb.Min, text_bb.Min), ImMax(check_bb.Max, check_bb.Max));
    }
    ...
    GetWindowDrawList()->AddRectFilled(check_bb.Min, check_bb.Max, GetColorU32(ImGuiCol_Passive), 3.f);
    if (*v)
        GetWindowDrawList()->AddRectFilled(check_bb.Min, check_bb.Max, GetColorU32(ImGuiCol_Active), 3.f);
    if (label_size.x > 0.0f)
...
void ImGui::Spacing(int spacing)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return;
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int* current_item)
{
    ...
    const ImRect frame_bb(window->DC.CursorPos + ImVec2(20 * c_menu::get().dpi_scale, 0), window->DC.CursorPos + ImVec2(w, label_size.y + style.FramePadding.y * 2.0f * c_menu::get().dpi_scale) + ImVec2(60 * c_menu::get().dpi_scale * c_menu::get().dpi_scale, 0));
    ...
    window->DrawList->AddRectFilled(frame_bb.Min, frame_bb.Max, GetColorU32(ImGuiCol_TitleBg), 5.f);
    GetWindowDrawList()->AddCircleFilled(ImVec2(value_x2 + 12 * c_menu::get().dpi_scale, frame_bb.Min.y + 12 * c_menu::get().dpi_scale), 3.5f, ImColor(255, 255, 255), 36);


    //window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(it_hover->second), 1.f);

    RenderText(ImVec2(frame_bb.Min.x, frame_bb.Min.y - 23 * c_menu::get().dpi_scale), label);
    PushStyleColor(ImGuiCol_Text, ImVec4(1.f, 1.f, 1.f, 1.f));
    if (preview_value != NULL && !(flags & ImGuiComboFlags_NoPreview))
        RenderTextClipped(frame_bb.Min + style.FramePadding + ImVec2(4 * c_menu::get().dpi_scale, 0) - ImVec2(0, 1 * c_menu::get().dpi_scale), ImVec2(value_x2, frame_bb.Max.y), preview_value, NULL, NULL, ImVec2(0.0f, 0.0f));
    PopStyleColor();
    it_open->second = ImClamp(it_open->second + (3.f * ImGui::GetIO().DeltaTime * (popup_open ? 1.f : -1.f)), 0.01f, 1.f);
    ...
    else
    {
        ...
        SetNextWindowSizeConstraints(ImVec2(255 * c_menu::get().dpi_scale, 0.0f), ImVec2(FLT_MAX, ((CalcMaxPopupHeightFromItemCount(popup_max_height_in_items)) * it_open->second)));
    ...
    PushStyleColor(ImGuiCol_PopupBg, GetColorU32(ImGuiCol_Active));
    PushStyleColor(ImGuiCol_Border, GetColorU32(ImGuiCol_Active));
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, bool minimum_damage, float power)
{
    ...
    const float w = CalcItemWidth();
    const ImVec2 label_size = CalcTextSize(label, NULL, true);
    const ImRect frame_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(242 * c_menu::get().dpi_scale, 27 * c_menu::get().dpi_scale));
    const ImRect total_bb(ImVec2(frame_bb.Min.x + 12 * c_menu::get().dpi_scale, frame_bb.Min.y), ImVec2(frame_bb.Max.x, frame_bb.Max.y));
    ...
    it_hover->second = math::clamp(it_hover->second + (2.15f * GetIO().DeltaTime * (hovered || IsItemActive() ? 1.f : -1.f)), 0.0f, 1.f);
    ...
    it_filled->second = math::clamp(it_filled->second + (1.15f * GetIO().DeltaTime), 0.0f, 1.f);
    it_filled->second *= min(GetStyle().Alpha * 1.5, 1.f);

    // Slider behavior
    ImRect grab_bb;
    const bool value_changed = SliderBehavior(total_bb, id, data_type, p_data, p_min, p_max, format, power, ImGuiSliderFlags_None, &grab_bb);
    if (value_changed)
        MarkItemEdited(id);
    auto draw = GetWindowDrawList();

    // Draw frame
    GetWindowDrawList()->AddRectFilled(ImVec2(total_bb.Min.x + 12 * c_menu::get().dpi_scale, frame_bb.Min.y + 11 * c_menu::get().dpi_scale), ImVec2(total_bb.Max.x - 12 * c_menu::get().dpi_scale, frame_bb.Max.y - 11 * c_menu::get().dpi_scale), GetColorU32(ImGuiCol_Passive), 8.f);
    GetWindowDrawList()->AddRectFilled(ImVec2(total_bb.Min.x + 12 * c_menu::get().dpi_scale, frame_bb.Min.y + 11 * c_menu::get().dpi_scale), ImVec2(grab_bb.Min.x + 7 * c_menu::get().dpi_scale, frame_bb.Max.y - 11 * c_menu::get().dpi_scale), GetColorU32(ImGuiCol_Active), 8.f);
    ...
    // GetWindowDrawList()->AddRectFilled(ImVec2(grab_bb.Min.x + 9, grab_bb.Min.y + 9), ImVec2(grab_bb.Max.x - 9, grab_bb.Max.y - 6), ImColor(0, 235, 240), 4);
    GetWindowDrawList()->AddCircleFilled(ImVec2(grab_bb.Min.x + 14 * c_menu::get().dpi_scale, grab_bb.Min.y + 12 * c_menu::get().dpi_scale), 7.f * c_menu::get().dpi_scale, ImColor(255, 255, 255), 36);
    ...
    RenderTextClipped(ImVec2(total_bb.Max.x + 5 * c_menu::get().dpi_scale, frame_bb.Min.y - 2 * c_menu::get().dpi_scale), ImVec2(total_bb.Max.x + 70 * c_menu::get().dpi_scale, frame_bb.Max.y), value_buf, value_buf_end, NULL, ImVec2(0.5f, 0.5f));

    if (label_size.x > 0.0f)
        RenderText(ImVec2(frame_bb.Min.x + 20 * c_menu::get().dpi_scale, frame_bb.Min.y - 15 * c_menu::get().dpi_scale), label);
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (is_multiline)
    {
        ...
        PushStyleColor(ImGuiCol_ChildBg, style.Colors[ImGuiCol_Passive]);
...
bool ImGui::ColorEdit(const char* label, Color* newcolor, ImGuiColorEditFlags flags, bool scripts, int value)
{
    ...
    const float w_button = (flags & ImGuiColorEditFlags_NoSmallPreview) ? 0.0f : (square_sz)+16;
    int valuev = 61.f / c_menu::get().dpi_scale;
    if (value == 1) {
        valuev = 61.f / c_menu::get().dpi_scale;
    }
    if (value == 2) {
        valuev = 90.f / c_menu::get().dpi_scale;
    }
    const float  w_inputs = w_full - w_button - valuev;
    ...
    const ImVec2 pos = ImVec2(window->DC.CursorStartPos.x + 175, window->DC.CursorPos.y);
    ...
    {
        const float button_offset_x = w_inputs + style.ItemInnerSpacing.x;
        ...
        if (ColorButton("##ColorButton", col_v4, flags, ImVec2(20 * c_menu::get().dpi_scale, 20 * c_menu::get().dpi_scale)))
        {
        ...
        if (BeginPopup("picker"))
        {
            ...
            SetNextItemWidth(square_sz * 14.0f); // Use 256 + bar sizes?
...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    const float w_inputs = w_full - w_button + 50.f;
    const char* label_display_end = FindRenderedTextEnd(label);
    g.NextItemData.ClearFlags();
...
bool ImGui::ColorPicker4(const char* label, float col[4], ImGuiColorEditFlags flags, const float* ref_col)
{
    ...
    float sv_picker_size = ImMax(bars_width * 1, width - (alpha_bar ? 2 : 1) * (bars_width + style.ItemInnerSpacing.x)) - 100; // Saturation/Value picking box
    ...
    float wheel_r_outer = sv_picker_size * 0.52f;
    ...
    */
    ...
    else if (flags & ImGuiColorEditFlags_PickerHueBar)
    {
        ...
        draw_list->AddRectFilled(ImVec2(bar0_pos_x, bar0_line_y - 2), ImVec2(bar0_pos_x + bars_width, bar0_line_y + 2), ImColor(255, 255, 255));
        draw_list->AddRect(ImVec2(bar0_pos_x, bar0_line_y - 2), ImVec2(bar0_pos_x + bars_width, bar0_line_y + 2), GetColorU32(ImGuiCol_Additional));
    }

    // Render cursor/preview circle (clamp S/V within 0..1 range because floating points colors may lead HSV values to be out of range)
    float sv_cursor_rad = value_changed_sv ? 10.0f : 6.0f;
    draw_list->AddCircleFilled(sv_cursor_pos, sv_cursor_rad, user_col32_striped_of_alpha, 14);
    draw_list->AddCircle(sv_cursor_pos, sv_cursor_rad + 1, col_midgrey, 14);
    draw_list->AddCircle(sv_cursor_pos, sv_cursor_rad, col_white, 14);
    ...
    if (alpha_bar)
    {
        ...
        draw_list->AddRectFilled(ImVec2(bar1_bb.Min.x, bar1_line_y - 2), ImVec2(bar1_bb.Max.x, bar1_line_y + 2), ImColor(255, 255, 255));
        draw_list->AddRect(ImVec2(bar1_bb.Min.x, bar1_line_y - 2), ImVec2(bar1_bb.Max.x, bar1_line_y + 2), GetColorU32(ImGuiCol_Additional));
    }
...
bool ImGui::ColorButton(const char* desc_id, const ImVec4& col, ImGuiColorEditFlags flags, ImVec2 size)
{
    ...
    if (size.y == 0.0f)
        size.y = default_size;
    const ImRect bb(window->DC.CursorPos + ImVec2(1, 5), window->DC.CursorPos + size - ImVec2(2, 0) + ImVec2(0, 2));
    ...
    if (hovered) {
        window->DrawList->AddRectFilled(bb_inner.Min - ImVec2(4, 4), bb_inner.Max + ImVec2(4, 4), GetColorU32(ImGuiCol_Passive), 4.f);
    }
    ...
    else
    {
        ...
        window->DrawList->AddImage(c_menu::get().icons[5], bb_inner.Min, bb_inner.Max, ImVec2(0, 0), ImVec2(1, 1), GetColorU32(ImVec4(col_source.x, col_source.y, col_source.z, 1.f)));
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    const ImVec4 text_act = ImColor(255, 255, 255, 255);
    const ImVec4 text_hov = ImVec4(251 / 255.f, 251 / 255.f, 251 / 255.f, 1.f);
    const ImVec4 text_dis = ImVec4(202 / 255.f, 202 / 255.f, 202 / 255.f, 1.f);
    float deltatime = 1.5f * ImGui::GetIO().DeltaTime;
