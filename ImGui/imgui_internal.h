...
namespace ImGui
{
    ...
    // Widgets
    IMGUI_API bool          TabEx(const char* label, int number, bool* active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          KeybindButton(const char* label, const char* unique_id, const ImVec2& size_arg = ImVec2(0, 0), bool clicked = false, ImGuiButtonFlags flags = 0, const char* text = "");
    ...
    IMGUI_API bool          MainTab(const char* label, int number, bool* active = false, const ImVec2& size_arg = ImVec2(0, 0));
