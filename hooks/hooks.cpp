...
namespace hooks
{
	...
	void GUI_Init(IDirect3DDevice9* pDevice)
	{
		...
		std::string segoeuibold_dir = (std::string)windows_directory + "\\Fonts\\segoeuib.ttf";


		c_menu::get().global = io.Fonts->AddFontFromFileTTF(segoeui_dir.c_str(), 20.f);
		c_menu::get().global2 = io.Fonts->AddFontFromFileTTF(segoeuibold_dir.c_str(), 17.f);
		c_menu::get().tab = io.Fonts->AddFontFromFileTTF(segoeuibold_dir.c_str(), 19.0f);
		c_menu::get().bold = io.Fonts->AddFontFromFileTTF(segoeuibold_dir.c_str(), 27.0f);

		if (c_menu::get().logo == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &logobyte, sizeof(logobyte), 50, 50, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().logo);
		if (c_menu::get().icons[0] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &ragebyte, sizeof(ragebyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[0]);
		if (c_menu::get().icons[1] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &aabyte, sizeof(aabyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[1]);
		if (c_menu::get().icons[2] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &legitbyte, sizeof(legitbyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[2]);
		if (c_menu::get().icons[3] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &worldbyte, sizeof(worldbyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[3]);
		if (c_menu::get().icons[4] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &playerbyte, sizeof(playerbyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[4]);
		if (c_menu::get().icons[5] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &colorbyte, sizeof(colorbyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[5]);
		if (c_menu::get().icons[6] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &miscbyte, sizeof(miscbyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[6]);
		if (c_menu::get().icons[7] == nullptr)
			D3DXCreateTextureFromFileInMemoryEx(pDevice, &cfgbyte, sizeof(cfgbyte), 16, 16, D3DX_DEFAULT, 0, D3DFMT_UNKNOWN, D3DPOOL_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, NULL, NULL, &c_menu::get().icons[7]);
